...
// // describe ("testing getProducts", async () => {
// //     let getProductsSpy: SinonSpy;
 
// //     beforeEach( () => {
// //         getProductsSpy = sinon.spy(getProduct);
// //     })
...
// //         delete req.query?.supplierId;
// //         await getProductsSpy(req, res)
// //         sinon.assert.called(getProductsSpy);
// //         sinon.assert.calledWith(jsonSpy, { error: "error" });
// //     })
// // })
...
// //     await getProductSpy(req as Request,res as Response)
// //     sinon.assert.called(getProductSpy)
...
//     const productCategory = req.query.product_category as string;
...
// import { getProducts } from '../../../src/controllers/products/getProductController';

// import * as serviceGetData from '../../../src/services/getproduct';
...
//     beforeEach(function () {
//         getProductsSpy = sinon.spy(getProducts);
//         jsonSpy = sinon.spy();
//         res = {
